...
| `output/reports/manuscript_composition.json` | Composition receipt: combined-markdown binding SHA-256, per-section source/rendered paths + hashes | `infrastructure/rendering/manuscript_composition.py` | 5 — Render PDF |
| `output/reports/rendered_provenance.json` | Rendered-provenance receipt: consumed manuscript sources with rendered/output hashes | `infrastructure/validation/publication/rendered_provenance.py` | 6 — Validate Output |
