...
\author{Daniel Ari Friedman\\\footnotesize{Active Inference Institute}\\\footnotesize{\texttt{daniel@activeinference.institute}}\\\footnotesize{\href{https://orcid.org/0000-0001-6232-9096}{ORCID: 0000-0001-6232-9096}} \\ \footnotesize{DOI: \href{https://doi.org/10.5281/zenodo.21086548}{10.5281/zenodo.21086548}}}
\date{\today}
...
the 90\% project gate by a zero-mock test suite, generates 13 artifacts
(1 figures, 6 data files, 6 reports) per pipeline run, and injects
reproducibility metadata (configuration hash \breaktt{23b5981d45bdc598},
build timestamp \breaktt{2026-06-30T23:02:10Z}) into
...
\begin{figure}
\centering
\pandocbounded{\includegraphics[keepaspectratio,alt={Steps per example method: a bar chart built from len(plan.steps) for each plan in output/data/compiled\_plans.json, plotted by scripts/methods\_analysis.py.}]{../figures/step_counts.png}}
...
injected: \breaktt{23b5981d45bdc598} is the SHA-256 of
\breaktt{manuscript/config.yaml} at build time, and
\breaktt{2026-06-30T23:02:10Z} records when the variables were generated
